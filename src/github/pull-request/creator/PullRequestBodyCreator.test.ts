...
describe('PullRequestBodyCreator', () => {
  describe('create', () => {
    ...
    it('returns Markdown string which does not contain repository information if package.json does not have repository field', async () => {
      ...
      extractRepositoryMock.mockReturnValue(undefined)
...
This PR has been generated by [${app.name}](${app.homepage}) v${app.version}`)
    ...
    describe('returns Markdown string which contains repository information if package.json has repository field', () => {
      const packageMetadata: PackageMetadata = {
        name: '@npm-update-package/example',
        version: '1.0.0',
...
|Package|Repository|Dependency type|Level|Version|
|---|---|---|---|---|
|[@npm-update-package/example](https://www.npmjs.com/package/@npm-update-package/example)|[npm-update-package/example](https://github.com/npm-update-package/example)|dependencies|major|[\`1.0.0\`](https://www.npmjs.com/package/@npm-update-package/example/v/1.0.0) -> [\`2.0.0\`](https://www.npmjs.com/package/@npm-update-package/example/v/2.0.0) ([diff](https://renovatebot.com/diffs/npm/@npm-update-package/example/1.0.0/2.0.0))|
